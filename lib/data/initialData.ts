...
export const initialProjects = [
  ...
  },
  {
    ...
    description: "A modern food delivery platform inspired by Swiggy and Zomato. Built with Next.js, React, Tailwind CSS, Node.js, Express.js, PostgreSQL, JWT Authentication, Restaurant Management, Cart, Online Ordering, Payment Integration, Admin Dashboard, Responsive Design, and Cloud Deployment.",
    techStack: ["Next.js", "React", "Tailwind CSS", "TypeScript", "Node.js", "Express.js", "PostgreSQL", "JWT", "REST API"],
